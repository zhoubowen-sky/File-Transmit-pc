    ...
    private void doPost() {
        try {
            ...
            if (echoFromPHP.equals("This_downloadnumber_is_null")) {
            	mainFrame.Msg2.setText("没有输入文件提取码！");

            } else if (echoFromPHP.equals("This_downloadnumber_is_not_valid")) {
            	mainFrame.Msg2.setText("此文件提取码无效！");
                ...
                try {
                    /**提示正在下载。。。*/
                	mainFrame.Msg2.setText("正在下载... ...请稍等");
                    // 构造URL
                ...
                mainFrame.Msg2.setText("编号" + HttpThread_DownLoad.DownLoadNumber + "文件下载完成，路径为下载目录");
            }
            /*********************************************/
